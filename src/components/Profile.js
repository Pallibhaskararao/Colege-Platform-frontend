...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const userRequest = axios.get('http://https://colege-platform-backend.onrender.com/api/users/profile', {
          headers: { Authorization: `Bearer ${token}` },
        });

        const branchesRequest = axios.get('http://https://colege-platform-backend.onrender.com/api/branches');

        const skillsRequest = axios.get('http://https://colege-platform-backend.onrender.com/api/skills');

        const postsRequest = axios.get('http://https://colege-platform-backend.onrender.com/api/posts/user/me', {
          headers: { Authorization: `Bearer ${token}` },
        });
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      const res = await axios.put(
        'http://https://colege-platform-backend.onrender.com/api/users/profile',
  ...
  const handleRemoveAcquaintance = async (acquaintanceId) => {
    ...
    try {
      const res = await axios.delete(`http://https://colege-platform-backend.onrender.com/api/users/acquaintances/${acquaintanceId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
